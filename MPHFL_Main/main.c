...
// CONFIG.C ET .H est OK (verifi�, test�)
// RAM.C ET .H est OK (verifi�, test�)
// IMAGE.C et .H OK (verifi�, test�)
// VRAM.C et .H est OK (verifi�, test�)
// IMAGEBMP <- A TERMINER MAIS OK POUR LA MEMOIRE (verifi�, test�)
// LANGUAGE <- OK (verifi�, test�)
// MENU.C ET .H corrig� (verifi�, test�)
// FONT.C ET .H OK (verifi�, test�)
// PSARDUMP.C ET .H OK (verifi�, test�)
// FILE.C ET .H OK (verifi�, test�)
// GRAPHIC.C ET .H OK normalement (verifi� presque entierement, reste plus que les blit mais normalement c bon)
